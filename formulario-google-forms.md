...
Numa coluna auxiliar da planilha de respostas, monte a lista de usuários
com uma fórmula que ignora células vazias, por exemplo (ajuste as letras
de coluna para onde ficaram os campos "Usuário do GitHub"):
...
como CSV com o cabeçalho `tema,usuarios_github`. Para 15-20 equipes por
